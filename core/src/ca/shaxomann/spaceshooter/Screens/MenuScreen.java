...
import ca.shaxomann.spaceshooter.Screens.PreferenceScreen;
import ca.shaxomann.spaceshooter.Screens.ScoreScreen;
...
public class MenuScreen implements Screen {
    ...
    public void show() {
        ...
        newGame.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                game.setScreen(new ca.shaxomann.spaceshooter.Screens.GameScreen(game));
            }
        });
