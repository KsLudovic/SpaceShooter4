...
class GameScreen implements Screen {
   ...
   // Sound explosionPlayer = Gdx.audio.newSound(Gdx.files.internal("explosionCrunch_001.ogg"));
    ...
    GameScreen(SpaceShooterGame spaceShooterGame){
        ...
        TextureRegion playerLaserTextureRegion = textureAtlas.findRegion("laserBlue03");
        ...
        // boss
        rapidFireBoss = new RapidFireBoss(WORLD_WIDTH/2,WORLD_HEIGHT+3,
                60,30,
                0, 300, 7f,50, 50,5f,
                rapidFireBossTextureRegion,enemyShieldTextureRegion,enemyLaserTextureRegion);
...
//        enemyBossShipRapidFire.draw(batch);
    ...
    private void spawnEnemyTank(float deltaTime){
        ...
        if(enemyTankTimer> timeBetweenTankSpawns){
        ...
        while (laserListIterator.hasNext()) {
            ...
            while(enemyTankListIterator.hasNext()) {
                ...
                if (enemyTank.intersects(laser.boundingBox)) {
                    ...
                    if(enemyTank.hitAndCheckIfDead(laser)){
                        ...
                        explosionList.add(new Explosion(explosionTexture,new Rectangle(enemyTank.boundingBox),0.7f));
            ...
            if(rapidFireBoss.intersects(laser.boundingBox)) {
                ...
                if(rapidFireBoss.hitAndCheckIfDead(laser)){
                    ...
                    explosionList.add(new Explosion(explosionTexture,new Rectangle(rapidFireBoss.boundingBox),3f));
